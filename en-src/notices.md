...
| Founding, joining, leaving a [sect](/cultivation/sects/) | Full-screen title — carrying **the sect's motto** underneath |
| A [skill node](/cultivation/skilltree/) unlocked | Corner notification |
| A [Life-Bound Treasure](/cultivation/lifebound/) leveling | Corner notification |
| A [race](/cultivation/races/) change, a respec | Corner notification |
| A ritual beginning — breakthrough, advancement, [refinement](/cultivation/refinement/) | Corner notification, as a warning |
...
Two moments keep their own, purpose-written titles regardless of these switches: **Qi Deviation** and the **Heart-Devil Trial**. [Tribulation](/cultivation/tribulations/) strikes show nothing here at all — they fire repeatedly, and a title per bolt would strobe.
...
Both live in the root `Config.json` — see the [Core config page](/cultivation/config/core/) — and both leave the chat lines untouched: switching a surface off never silences the event, it only changes how loudly it lands.
