...
|:---|:---|:---|
| **4 technique binds** | ALT+6, ALT+7, ALT+8, ALT+9 | Any [technique](/cultivation/techniques/) you have learned |
...
Since **v0.7.4** the technique dropdown only offers arts you have actually [come by](/cultivation/techniques/#unlocking), so no key can be bound to something that cannot fire. An art you have not learned yet simply is not in the list.

A [gathered art](/cultivation/techniques/#gathered-arts) bound to a key uses that key **twice**: once to begin gathering, once to loose it. A [fist art](/cultivation/techniques/#fist-arts) bound to a key refuses while a weapon is in hand, exactly as it does from the command.
