...
| **ALT+4** | Bound to the Codex out of the box — see [Keybinds](/cultivation/keybinds/). |

#### The Four Sections

| Section | Covers |
|:---|:---|
| **The Path** | [Realms](/cultivation/realms/), [Qi](/cultivation/qi-gathering/), breakthroughs, [tribulation](/cultivation/tribulations/) |
| **The Self** | [Race](/cultivation/races/), the [Dao](/cultivation/dao/), [techniques](/cultivation/techniques/), [companions](/cultivation/beasts/) |
| **The World** | [Spirit veins](/cultivation/qi-gathering/), [sects](/cultivation/sects/), [abodes](/cultivation/dwelling/), [formations](/cultivation/formations/) |
| **The Craft** | [Alchemy](/cultivation/alchemy/), [refinement](/cultivation/refinement/), [manuals](/cultivation/manuals/) |
...
Registering an existing id **replaces** it, which is how a mod rewrites a built-in article rather than adding beside it. Full details in [Registries](/cultivation/api/registries/).
