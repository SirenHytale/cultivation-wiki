#!/usr/bin/env python3
"""Render tools/card.html to assets/img/social-card.png (1200x630).
...
CARD = ROOT / "tools" / "card.html"
OUT = ROOT / "assets" / "img" / "social-card.png"
TARGET = (1200, 630)
...
def main() -> None:
    ...
    print(f"\nwrote {OUT.relative_to(ROOT)} at {png_size(OUT)} — not exactly {TARGET}, "
