...
**宗门之战**只有一件事：围攻敌对[宗门](/cultivation/sects/)已占的大殿。没有积分、没有击杀数、没有据点 —— 攻方宗门只需在战期耗尽之前，无人争夺地在那块争议区块上站够时候。胜则大殿易主。
...
|:---|:---|
| 同一宗门 | 你无法围攻自己。 |
| 目标并无大殿 | 无物可夺。大殿如何设立，见[宗门](/cultivation/sects/)。 |
...
flowchart TD;
    ...
    click Declare "/cultivation/sects/" "前往宗门页";
```
...
- 双方都在世界原本的 PvP 规则之下厮杀。守方自家的[阵法](/cultivation/formations/)在此大有助益：护山大阵扼制外人在自家地界上的灵气恢复，而困仙阵则直接定住并伤及入侵者。
...
- 大殿共享的**灵泉**，连同其中所蓄的一切，会在下一次扫描时随地界归于胜者。见[洞府](/cultivation/dwelling/)。
- 败者的**殿上碑文**就此熄灭。大殿一去，其所授之法立刻从他们每一名门人处收回。碑文本身不会被夺 —— 它仍记录在败方宗门之上，他们日后若另立新殿便会重新授法；而胜者自己的碑文分毫未动。
- [阵法](/cultivation/formations/)**不会**易主。无论坐落何处，它们始终由布下它们的宗门掌控。
...
`Wars-Enabled`、`War-Required-Hold-Seconds`、`War-Window-Seconds`、`War-Defender-Grace-Seconds`、`War-Cooldown-Hours` 与 `War-Requires-Defender-Online` 皆位于宗门社群配置之中 —— 完整参考见[宗门社群配置](/cultivation/config/society/)，模组的全部指令见[指令](/cultivation/commands/)页。
