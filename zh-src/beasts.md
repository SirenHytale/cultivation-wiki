...
养成的灵兽不只是一副跟在身后的数值。自 **0.7.2** 起，它会习得**属于自己的功法** —— 与你的[功法](/cultivation/techniques/)相对的兽一侧，各有冷却与解锁境界。
...
> **两种赶路的法子。** 坐骑是除[御剑飞行](/cultivation/techniques/)之外的另一种，且与御剑不同 —— 它赶路不耗分毫灵气。两者都是普通的右键乘骑；若在 0.7.2 之前的版本上右键毫无反应，那是本版修正的交互缺陷，不是你做错了。
