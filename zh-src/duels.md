...
- `/cultivation duel challenge <玩家> [押注]` 押上你相应数额的存蓄灵气，并向对方发起赌斗。省略押注，或填了个不是数字的东西，都按 **0** 处理 —— 那是一场不带彩头的意气之争。
...
**因死而定。** 赌斗是由一方**身死**来判定的，而非由谁下的手。无论最后一击是对手自己落下的、是他的[灵兽](/cultivation/beasts/)落下的、是第三方插手，还是败者不过是自己淹死了，胜利都归对手。判定得再窄一分，就会留下永远无法了结的赌斗。
...
灵气是从你的存蓄总额中划走的，并不触及你的境界与阶段。存蓄灵气用在何处，见[境界与阶段](/cultivation/realms/)。
...
- 被救回的这一击此后仍会流经 Cultivation 自己的全部伤害过滤器，因此境界缩放、[大道](/cultivation/dao/)转化、本命法宝与功法效果一切照常生效。
...
`Duels-Enabled`、`Duel-Challenge-Expiry-Seconds`、`Duel-Max-Wager`、`Duel-Overrides-World-Pvp` 与 `Duel-Max-Duration-Seconds` 皆位于宗门社群配置之中 —— 完整字段参考见[宗门社群配置](/cultivation/config/society/)，模组的全部指令见[指令](/cultivation/commands/)页。修士之间动手的其他途径，见[宗门攻伐](/cultivation/wars/)与[宗门](/cultivation/sects/)。
