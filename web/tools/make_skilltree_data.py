#!/usr/bin/env python3
"""Generate lib/data/skilltree.json — the node data the build planner runs on.
...
lib/tools/planner.js imports the JSON directly, so this file is the only step
between the mod's Java and what the planner draws.
"""
...
OUT = pathlib.Path(__file__).resolve().parent.parent / "lib" / "data" / "skilltree.json"
