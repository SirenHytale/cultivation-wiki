...
<CardGrid cols={3}>
  ...
  <CardLink href="/api/" title="Public API" han="匠">
    156 events across twelve subsystems, open registries, and a provider hook that lets a mod replace the ladder entirely.
  </CardLink>
</CardGrid>
...
Where every mortal begins — tempering flesh before energy.
...
Ambient spirit energy first gathers and holds inside the body.
...
The base is laid; progress stops being reversible by accident.
...
A core forms. Your race may be chosen here, once.
...
The soul takes an infant form and can act apart from the body.
...
Soul and body fuse into something no longer quite human.
...
The last realm before the mortal world stops being enough.

REALM VII

[Full realm mechanics →](/realms/)
