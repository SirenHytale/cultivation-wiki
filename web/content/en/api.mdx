...
- **Listen** to (and re-tune, or veto) 160 events across every subsystem in the mod. See [API Events](/api-events/).
...
<Note>
  **The sources are published.** Every public API class, with its javadoc, lives at [github.com/SirenHytale/Cultivation-API](https://github.com/SirenHytale/Cultivation-API) — alongside a generated reference for all 160 events, a worked example add-on, and a brief written for AI coding assistants. The javadoc in those sources is the authoritative contract; this wiki is the guided tour.
</Note>
