...
Tempering flesh and sinew before a single wisp of energy will hold.
...
Ambient spirit energy finally gathers and stays inside the body.
...
The base is laid. From here the climb is steep but no longer fragile.
...
A core forms in the dantian — and your one-time race choice unlocks.
...
The soul takes an infant form and can act briefly apart from the body.
...
Soul and body fuse into something the mortal world no longer recognises.
...
The last realm the mod ships — and the last one the world can hold.
