...
Everything below describes what each file stores, not how to tune it. The tunable settings for these systems live in the [Society Configs](/config-society/).
