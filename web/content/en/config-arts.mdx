...
The seven files in `mods/Siren_Cultivation/Arts/` cover everything a cultivator practices, crafts, tempers, and binds to themselves - the [Dao](/dao/) they walk, the [Techniques](/techniques/) they perform, the [Manuals](/manuals/) that teach them, the pills they brew in [Alchemy](/alchemy/), the [Weapon Refinement](/refinement/) they endure, their [Life-Bound Treasures](/lifebound/), and their [Spirit Beasts](/beasts/).
...
| "Requires-Manual" | false | When true this technique cannot be performed until a [manual](/manuals/) has taught it. None of the nine built-ins set this by default. |
