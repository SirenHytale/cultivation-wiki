...
A **Formation (阵法)** is a spirit array inscribed into the ground, anchored to one chunk and reaching out over the chunks around it. There are three kinds: one that feeds your own cultivation, one that starves everyone else's, and one that hurts anybody who walks in uninvited. They are how a [Sect](/sects/) turns a claimed mountain into ground that actually defends itself.
...
A Mountain-Guarding Array does more than choke Qi: outsiders also cannot inscribe their own formations on warded ground, and cannot claim a [Cave Abode](/dwelling/) there.
...
- **Renaming a sect** carries its formations with it (see [Sects](/sects/)), so a sect never ends up warded and trapped by its own arrays.
...
See [Qi Gathering](/qi-gathering/) for where cultivation cores come from. None of the three flags drops on death.
...
- Placement is refused on ground warded against you, whether by someone else's Mountain-Guarding Array or by a sustained [Cave Abode](/dwelling/).
...
A [Cave Abode](/dwelling/)'s own meditation multipliers are applied separately from this, on top.
...
Every value on this page lives in the society config - see [Society Config](/config-society/) for the full field reference, and [Commands](/commands/) for every command in the mod. Formations interlock with [Sects](/sects/), defend a hall during [Sect Wars](/wars/), and share their warding rules with [Cave Abodes](/dwelling/).
