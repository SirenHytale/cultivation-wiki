...
| **ALT+4** | 默认即绑定至典籍 —— 见[快捷键](/zh/keybinds/)。 |

## 四大部类

| 部类 | 涵盖 |
| --- | --- |
| **修行之路** | [境界](/zh/realms/)、[灵气](/zh/qi-gathering/)、突破、[天劫](/zh/tribulations/) |
| **己身** | [种族](/zh/races/)、[大道](/zh/dao/)、[功法](/zh/techniques/)、[灵兽](/zh/beasts/) |
| **天地** | [灵脉](/zh/qi-gathering/)、[宗门](/zh/sects/)、[洞府](/zh/dwelling/)、[阵法](/zh/formations/) |
| **炼制** | [炼丹](/zh/alchemy/)、[炼器](/zh/refinement/)、[秘籍](/zh/manuals/) |
...
注册一个已存在的 id 会**取而代之**，模组便是以此改写内置记载，而非另立一篇。详见[注册表](/zh/api-registries/)。
