...
<RealmTrack>
      <Realm color="#9E8B78" medal="體" name="炼体" sub="凡人皆由此始 —— 先淬炼皮肉筋骨，而后方能纳气。" tier="第一重" />
      <Realm color="#7EA8D9" medal="氣" name="炼气" sub="天地灵气初次汇入体内，并能长驻不散。" tier="第二重" />
      <Realm color="#6FBF9B" medal="築" name="筑基" sub="道基既成，修为不再因一时闪失而倒退。" tier="第三重" />
      <Realm color="#E0B44C" medal="丹" name="金丹" sub="金丹凝结。种族之选，于此开启，仅有一次。" tier="第四重" />
      <Realm color="#A98BD1" medal="嬰" name="元婴" sub="元神化婴，可离体而行。" tier="第五重" />
      <Realm color="#D97E7E" medal="神" name="化神" sub="神魂与躯壳相融，已非纯粹凡人之躯。" tier="第六重" />
      <Realm color="#F6D77B" medal="虛" name="炼虚" sub="凡尘再难承载之前的最后一重境界。" tier="第七重" />
    </RealmTrack>

<Center>
      <ButtonLink href="/realms/" ghost>完整境界机制 →</ButtonLink>
    </Center>
